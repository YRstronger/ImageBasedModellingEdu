...
int main(int argc, char* argv[])
{
    ...
    //TODO 对A矩阵进行赋值
    // add by rui
	std::vector<math::Vec4d> vVec4d(4);
	vVec4d[0] = P1.row(2) * p1[0] - P1.row(0);
	vVec4d[1] = P1.row(2) * p1[1] - P1.row(1);
	vVec4d[2] = P2.row(2) * p2[0] - P2.row(0);
	vVec4d[3] = P2.row(2) * p2[1] - P2.row(1);
	math::Matrix<double, 4, 4> A(vVec4d[0].begin());//vector容器内存区域连续，获得头指针以初始化A矩阵
