...
FundamentalMatrix fundamental_8_point (math::Matrix<double, 3, 8> const& points1
	...
	// solve Af=0 and get f
	math::Matrix<double, 9, 9> solution;
	math::matrix_svd<double, 8, 9>(A, nullptr, nullptr, &solution);
    //std::cout <<solution<<std::endl;
	math::Vector<double, 9> f = solution.col(8); //最后一行为最小奇异值对应行
